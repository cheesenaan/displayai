    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("UNIVERSITY_START_DATE", models.DateField(null=True)),
                ("UNIVERSITY_END_DATE", models.DateField(null=True)),
                ("MAJOR", models.CharField(max_length=100, null=True)),
                ("MINOR", models.CharField(max_length=100, null=True)),
                ("GPA", models.FloatField(null=True)),
                ("EXPERIENCE1", models.CharField(max_length=200, null=True)),
                ("EXPERIENCE1_START_DATE", models.DateField(null=True)),
                ("EXPERIENCE1_END_DATE", models.DateField(null=True)),
                ...
                ("EXPERIENCE2_START_DATE", models.DateField(null=True)),
                ("EXPERIENCE2_END_DATE", models.DateField(null=True)),
                ...
                ("EXPERIENCE3_START_DATE", models.DateField(null=True)),
                ("EXPERIENCE3_END_DATE", models.DateField(null=True)),
                ...
                ("EXPERIENCE4_START_DATE", models.DateField(null=True)),
                ("EXPERIENCE4_END_DATE", models.DateField(null=True)),
                ...
                ("EXPERIENCE5_START_DATE", models.DateField(null=True)),
                ("EXPERIENCE5_END_DATE", models.DateField(null=True)),
